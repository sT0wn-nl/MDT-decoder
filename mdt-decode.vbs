...
Dim strDomain
WScript.StdOut.Write("Enter encoded domain>")
WScript.StdIn.Read(0)
strDomain= WScript.StdIn.ReadLine()
Dim strUsername
WScript.StdOut.Write("Enter encoded username>")
WScript.StdIn.Read(0)
strUsername= WScript.StdIn.ReadLine()
Dim strPassword
WScript.StdOut.Write("Enter encoded password>")
WScript.StdIn.Read(0)
strPassword= WScript.StdIn.ReadLine()
WScript.StdOut.Write("=============================" & vbCrLf)

WScript.StdOut.Write("Decoded domain: " & WM_DecodeEncodedValue(strDomain) & vbCrLf)
WScript.StdOut.Write("Decoded username: " & WM_DecodeEncodedValue(strUsername) & vbCrLf)
WScript.StdOut.Write("Decoded password: " & WM_DecodeEncodedValue(strPassword) & vbCrLf)
